...
public class DijkstraSrcToDest {
    public static void main(String []args){
        ...
        dijkstra(src,g,n,vis,psf,wsf,dest);
    }

    private static void dijkstra(int src, List<Graph>[] g, int n, boolean[] vis, String psf, int wsf,int dest) {
